  ...
  while($fila = $resultado->fetch(PDO::FETCH_ASSOC)){
    ...
    $salida.="<article class='card card__ecommerce'><div class='card__body'>
              ...
              <div class='card__footer--left'>
                <a class='card__button' ><button class='button btn-solid-primary buy-button' onclick='mialerta()'>Agregar al carrito</button></a>
              </div>
              <div class='card__footer--right'>
                <a><img class='icon-md icon-danger' src='https://raw.githubusercontent.com/VishalPatil18/VISPA-UI/main/assets/shopping-cart.svg' alt='heart-icon'/></a>
